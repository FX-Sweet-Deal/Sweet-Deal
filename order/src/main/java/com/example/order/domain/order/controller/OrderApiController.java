...
public class OrderApiController {
  ...
  @PostMapping
  public Api<OrderRegisterResponse> create(@RequestBody OrderRegisterRequest orderRegisterRequest,
  ...
  public Api<MessageResponse> payment(@PathVariable("orderId") Long orderId,
      @RequestBody PaymentRequest paymentRequest, Long userId) {// 임시 userId
  ...
  public Api<MessageResponse> cancel(@PathVariable Long orderId, Long userId) {
  ...
  public Api<MessageResponse> cancelStore(@PathVariable Long orderId, Long userId) {
    MessageResponse messageResponse = orderBusiness.cancelStoreOrder(orderId, userId);
    return Api.ok(messageResponse);
  }

  @GetMapping("/user/{userId}") // 임시
